...
$(document).ready(function () {
    ...
    //     nav: true,
    //     margin: 10,
    //     navText: ['<i class="fa fa-angle-left"></i><span>Previous</span>', '<span>Next</span><i class="fal fa-angle-right"></i>'],
    //     responsive: {
    //         768: {
    //             navText: ['<i class="fa fa-angle-left"></i><span>Previous</span>', '<span>Next</span><i class="fal fa-angle-right"></i>']
    //         },
    //         575: {
    //             navText: ['<i class="fa fa-angle-left"></i><span></span>', '<span></span><i class="fal fa-angle-right"></i>']
    //         },
    //         0: {
    //             navText: false
    //         }
