<div class="container table-responsive">
    <form id="return-booking" action="{{ route('bookings.store') }}" method="POST">
        ...
        <table class="table table-responsive-lg table-bordered" border="1">
            ...
            <tr>
                <td><b>Date, Time </b></td>
                <td colspan="2"> <input type="date" value="{{ $booking->pickup_date }}" id="datepicker" required
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" value="{{ $booking->luggage }}" name="luggage" id="luggage"
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" value="{{ $booking->destination }}"
                        class="form-control pg-autocomplete" required name="pickup_address" placeholder="Enter From">
                </td>
                <td colspan="3"><input type="text" value="" placeholder="House/flight no"
                        class="form-control" name="house_no_from" id="from1" required>
                </td>
            </tr>
            <tr>
                <td><b>To</b></td>
            ...
            <tr>
                ...
                <td colspan="1"><input type="text" value="{{ $booking->phone }}" class="form-control"
                        id="mobile" name="mobile" placeholder="Enter Mobile Number">
                </td>
                <td colspan="2"><input type="email" value="{{ $booking->email }}" class="form-control"
                        name="email" id="email" placeholder="Enter E-mail"></td>
            ...
            <tr>
                <td><b>Remark</b></td>
                <td colspan="5">
                    <textarea class="form-control" value="#" id="cancel-btn" name="remark" id="remark"
