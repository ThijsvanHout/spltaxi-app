...
<body>
	...
	@if($invoice[0]->from == "nvt")
		<div class="center-img" style="border:solid 8px red; width:30%; padding:10px;">
			<p>LET OP!<p>
			<p>Het bedrijf {{ $invoice[0]->company }} heeft geen ritten gehad in {{ $invoice[0]->monthName }} {{ $invoice[0]->year }}</p>
		</div>
	@else
		<div id="contentToExport">
			...
			<div class="mt-3">
				<div class="row d-flex">
					<div class="col-sm-3" style="font-size: larger; font-weight:bold;">Bedrijf</div>
					<div class="col-sm-4" style="font-size: larger; font-weight:bold;">:  {{ $invoice[0]->company }}</div>
				</div>
							...
							<table class="table-responsive table-borderless">
								...
								<tbody>
									<tr>
										...
										<td class="ml-3" id="companyField"></td>
									</tr>
									<tr>
...
<script>
	$('#editInvoiceModal').on('show.bs.modal', function (event) {
	  ...
	  modal.find('#companyField').text(company);
