...
<body>
	...
	@if($invoice[0]->from == "nvt")
		<div class="center-img" style="border:solid 8px red; width:30%; padding:10px;">
			<p>LET OP!<p>
			<p>De chauffeur {{ $invoice[0]->driver_name }} heeft geen ritten gehad in {{ $invoice[0]->monthName }} {{ $invoice[0]->year }}</p>
		</div>
	@else
		<div id="contentToExport">
			...
			<div class="mt-3">
				<div class="row d-flex">
					<div class="col-sm-3" style="font-size: larger; font-weight:bold;">Chauffeur</div>
					<div class="col-sm-4" style="font-size: larger; font-weight:bold;">:  {{ $invoice[0]->driver_name }}</div>
				</div>
			...
			<form action="{{ route('invoice.update') }}" method="POST">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
							...
							<input type="hidden" id="driverIdField" name="driverId">
							...
							<table class="table-responsive table-borderless">
								...
								<tbody>
									<tr>
										<td style="font-weight:bold; padding-right:10px;">Driver</td>
										<td class="ml-3" id="driverField"></td>
									</tr>
									<tr>
...
<script>
	...
	document.getElementById('downloadPdf').addEventListener('click', function () {
        ...
        var invoiceDetails = [
            [{ text: 'Chauffeur', bold: true }, { text: invoiceData[0].driver_name }],
