    ...
    <form id="return-booking" action="{{ route('bookings.adminstore') }}" method="POST">
        ...
        <table class="table table-responsive-lg table-bordered" border="1">
            ...
            <tr>
                <td><b>Date</b></td>
                <td colspan="1">
                    <input type="date" value="{{ $booking->pickup_date }}" id="datepicker" required
                        name="pickup_date" class="form-control datepicker">
                </td>
            </tr>
            <tr>
                <td><b>Time</b></td>
                <td>
                    <input type="time" value="{{ $booking->pickup_time }}" required name="pickup_time"
            ...
            <tr>
                <td><b>From</b></td>
                <td colspan="1">
                    <input type="text" value="{{ $booking->destination }}" class="form-control pg-autocomplete"
                        required name="pickup_address" placeholder="Enter From">
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="1">
                    @if (strpos(strtolower($booking->destination), 'schiphol') !== false)
                        <input type="text" value="Flight" placeholder="To House From " class="form-control"
                            name="flight_no" id="from1">
                        <input type="text" value="House no" hidden class="form-control" name="house_no_from">
                    @else
                        <input type="text"
                            value="{{ $booking->house_no_to === '-' || $booking->house_no_to === null ? '-' : $booking->house_no_to }}"
                            placeholder="To House From " class="form-control" name="house_no_from" id="from1">
                        <input type="text" value="Flight " hidden class="form-control" name="house_no_from">
                    @endif
                </td>
            </tr>
            <tr>
                <td><b>To</b></td>
                <td colspan="1">
                    <input type="text" value="{{ $booking->pickup_address }}" class="form-control pg-autocomplete"
                        id="to" name="to" placeholder="Enter Destination">
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="1">
                    @if (strpos(strtolower($booking->pickup_address), 'schiphol') !== false)
                        <input type="text" value="Flight " placeholder="To House No " class="form-control"
                            name="flight_no_to">
                        <input type="text" value="House no " hidden class="form-control" name="house_no_to">
                    @else
                        <input type="text"
                        ...
                        <input type="text" value="Flight no " hidden class="form-control" name="flight_no_to">
                    @endif
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="input-group mb-2">
                        <input type="text" name="price"
                            value="{{ $booking->price === null || $booking->price === '' ? '€ ' : $booking->price }}"
            ...
            <tr>
                <td><b>Mobile</b></td>
                <td colspan="1">
                    <input type="text" value="{{ $booking->phone }}" class="form-control" id="mobile"
            ...
            <tr>
                ...
                <td>
                    <input type="text"
                        ...
                        class="form-control" name="press" id="press" placeholder="Enter No of Passenger">
                </td>
            </tr>
            <tr>
                <td><b>Luggage</b></td>
                <td colspan="1">
                    <input type="text"
                        ...
                        name="luggage" id="luggage" class="form-control" placeholder="Enter No of Luggage">
                </td>
            </tr>
            <tr>
                <td><b>Vehicle</b></td>
            ...
            <tr>
                <td><b>E-mail</b></td>
                <td colspan="1">
                    <input type="email" value="{{ $booking->email }}" class="form-control" name="email"
        ...
        <div class="row">
            <div>
                <button class="btn btn-primary"><a href="{{ url('/admin/bookings') }}"
        ...
        function showPosition(position) {
            ...
            geocoder.geocode({
                ...
                if (status === google.maps.GeocoderStatus.OK) {
                    if (results[0]) {
                        document.getElementsByClassName('pg-autocomplete')[0].value = results[0]
                            .formatted_address;
                    }
                }
            });
