											...
											<div class="dropdown-content" hidden >									
												...
												@else
													<button type="button" 
														...
														data-id="{{ $booking->id }}" data-target="#assignDriverModal">
														Assigned
													</button>
												@endif

												<button type="button" class="no-border-btn btn-block bg-gradient-primary complete-ride-btn" data-id="{{ $booking->id }}">
														Complete
												</button>
							...
							<table class="table table-responsive table-bordered">
								...
								<tr>
									...
									<td style="width:20%"><select name="mode" id="mode" class="form-control">
											...
											<option value="Master Card" @if ($booking->mode === 'Master Card') selected @endif>Master Card
											</option>
											<option value="American Express" @if ($booking->mode === 'American Express') selected @endif>
