...
<div class="container table-responsive">
    <form id="add-booking-form" action="{{ route('bookings.adminstore') }}" method="POST">
        ...
        <table class="table table-responsive-lg table-bordered" border="1">
            ...
            <thead>
                <th colspan="2" class="text-center align-middle"><button type="submit" class="btn btn-red">Add
                        booking</button></th>
            </thead>
            <tr>
                <td><b>Date </b></td>
                <td>
                    <input type="date" id="datepicker" required name="pickup_date"
                        value="{{ now()->toDateString('dd-mm-yyyy') }}" class=" datepicker">
                </td>
            </tr>
            <tr>
                <td><b>Time </b></td>
                <td>
                    <input type="time" required name="pickup_time" placeholder="HH:mm" class="">
                </td>
            </tr>

            <tr>
                <td><b>From</b></td>
                <td colspan="1"><input type="text" required class="form-control pg-autocomplete" value=""
                        name="pickup_address" placeholder="Enter From"></td>

            </tr>
            <tr>
                <td><b>House no</b></td>
                <td colspan="1"><input type="text" class="form-control" value="House no " name="house_no_from"
                        placeholder="House No"></td>
            </tr>
            <tr>
                <td><b>Flight no</b></td>
                <td colspan="1"><input type="text" class="form-control" value="Flight " name="flight_no"
            ...
            <tr id="schiphol">
                <td><b>House no</b></td>
                <td colspan="1"><input type="text" required class="form-control" id="house_to" name="house_no_to"
                        value="House no " placeholder="House No "></td>
            </tr>
            <tr id="schiphol">
                <td><b>Flight no</b></td>
                <td colspan="1"><input type="text" required class="form-control" id="house_to" name="house_no_to"
                        value="Flight " placeholder="Flight No."></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="1"><input type="text" class="form-control" name="press" id="press"
                        value="Pax " placeholder="Enter No of Passenger"></td>
            </tr>
            <tr>
                <td><b>Luggage</b></td>
                <td colspan="1"><input type="text" name="luggage" id="luggage" class=""
                        value="Luggage " placeholder="Enter No of Luggage"></td>
            </tr>
            <tr>
                <td><b>Vehicle</b></td>
            ...
            <tr>
                ...
                <td colspan="1">
                    <select class="" name="return" id="choice">
            ...
            <tr class="rethide">
                <td><b>Date</b></td>
                <td colspan="1">
                    <input class="" type="date" name="flight_date" id="flight_date" placeholder="">
                </td>
            </tr>
            <tr class="rethide">
                <td><b>Time</b></td>
                <td colspan="1">
                    <input type="time" name="flight_time" id="flight_time" class="">
                </td>
            </tr>
            <tr class="rethide">
                <td><b>Flight no</b></td>
                <td colspan="1">
                    <input class="form-control" type="text" name="flight_no_on_return" id="flight_no_on_return"
                        value="Flight " placeholder="">
                </td>
            </tr>
            <tr class="rethide">
