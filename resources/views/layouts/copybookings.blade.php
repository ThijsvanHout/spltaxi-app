...
<div class="container table-responsive">
    <form id="copy-booking-form" action="{{ route('bookings.adminstore') }}" method="POST">
        ...
        <table class="table table-responsive-lg table-bordered" border="1">
            ...
            <thead>
                <th colspan="2" class="form-control"><button type="submit" class="btn btn-red">Copy booking</button>
                </th>
            </thead>
            <tr>
                <td><b>Date</b></td>
            ...
            <tr>
                <td><b>From</b></td>
                <td colspan="1"><input type="text" value="{{ $booking->pickup_address }}" required
                        class="form-control pg-autocomplete" value="" name="pickup_address"
            ...
            <tr>
                ...
                <td colspan="1"><input type="text" class="form-control pg-autocomplete" id="to"
                        value="{{ $booking->destination }}" name="to" required value="Schiphol"
                ...
                <td colspan="1">
                    <select name="company" id="company">
                        ...
                        @foreach ($companies as $company)
                            <option value="{{ $company->naam }}" @if ($booking->company === $company->naam) selected @endif>
                                {{ $company->naam }}</option>
                        @endforeach
                    </select>
                </td>
            ...
            <tr>
                ...
                <td colspan="1"><input type="text" class="form-control" id="mobile" name="mobile"
                        value="{{ $booking->phone }}" placeholder="Enter Mobile Number"></td>
            </tr>
            <tr>
                <td><b>Name</b></td>
                <td colspan="1"><input type="text" name="uname" id="uname" class="form-control"
                        value="{{ $booking->name }}" placeholder="Enter Your Name"></td>
            </tr>
            <tr>
                <td><b>Person(s)</b></td>
            ...
            <tr>
                ...
                <td colspan="1"><input type="email" class="" name="email" id="email"
                        value="{{ $booking->email }}" placeholder="Enter E-mail"></td>
            </tr>
        </table>
        <style>
            .rethide {
