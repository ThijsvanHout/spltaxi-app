            ...
            <form id="booking-form" method="post" action="{{ route('bookings.store') }}">
                ...
                <div class="row">
                    ...
                    <table class="table table-responsive table-bordered">
                        <tr>
                            <td><b>Date, Time </b></td>
                            <td colspan="2"> <input type="date" id="datepicker" required min="<?php echo date('Y-m-d'); ?>"
                                    name="pickup_date" class="form-control datepicker"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input type="text" class="form-control" value="" required
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input type="text" class="form-control" id="house_to" name="house_no_to"
                                    required value="-" placeholder=" House No."></td>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><input type="text" class="form-control" required id="mobile"
                                    name="mobile" placeholder="Enter Mobile Number"></td>
                            <td colspan="2"><input type="email" class="form-control" required name="email"
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input required type="text" name="luggage" id="luggage"
                                    class="form-control" placeholder="Enter No of Luggage"></td>
                        ...
                        <tr>
                            ...
                            <td class="rethide" colspan="2"><input class="form-control" type="text"
                                    name="flight_no_on_return" id="flight_no_on_return" placeholder="Flight No"></td>

                            <td class="rethide" colspan="1"><input class="form-control" type="date"
                                    name="flight_date" id="flight_date" min="<?php echo date('Y-m-d'); ?>" placeholder=""></td>
                            <td class="rethide" colspan="1"><input type="time" name="flight_time"
                                    id="flight_time" class="form-control"></td>
                        </tr>
                        <tr class="rethide">
