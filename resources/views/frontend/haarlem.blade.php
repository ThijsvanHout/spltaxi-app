...
<footer class="clr2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text">
                    <h4>Haarlem (Noord-Holland) Luchthaven Taxi</h4>
                    <h3>Tarief Van Haarlem provincie Noord-Holland naar Schiphol =
                        € 40,00</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text fot-text2">
                    <h4>Haarlem (Noord-Holland) Luchthaven Taxi</h4>
                    <h4>Voor  € 40,00 Vaste Prijs met de Taxi van Haarlem naar Luchthaven!</h4>
                    <h4>
                        Wij bieden u professionele taxi’s naar Schiphol vanuit Haarlem, maar ook vanuit <a href="#">Ouderkerk aan de Amstel</a>, <a href="#">Schalkwijk</a>, <a href="#">Nieuwe Brug</a>, <a href="#">Zuid-Schalkwijk</a>, <a href="#">Vijfhuizen</a>, <a href="#">Heemstede</a>, <a href="#">Penningsveer</a>, <a href="#">Aerdenhout</a>, <a href="#">Haarlemmerliede</a>, Cruquius en meer locaties rond <a href="#">Amstelveen</a>
                    </h4>
                </div>
            </div>
        </div>
...
<footer class="clr2 footer2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="fot-text fot-text2">
                    <h4>Vaste Prijs met de Taxi van Haarlem naar Luchthaven!</h4>
                    <h4>Auto € 40,00</h4>
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="fot-text fot-text2">
                    <h4>Waarom kiezen voor Taxi vervoer van Haarlem naar Luchthaven Schiphol?</h4>
                    <h3>Wij bieden Taxi vervoer van Haarlem Noord-Holland naar luchthaven</h3>
                    <p>
                        Reizen per vliegtuig moet plezierig zijn. Je ervaart bijvoorbeeld een andere stad, ervaart nieuw eten en ontmoet mensen. Reizen is een opwindende ervaring, dus zorg ervoor dat alles soepel verloopt vanaf het moment dat u naar het vliegveld gaat, op het vliegveld landt tot u weer op weg naar huis bent. Daarom is de vraag, hoe moet u uw vakantie of zakelijke reis stressvrij beginnen? Uiteraard, neem een luchthaven taxi!</p>
                    <ul class="foot-list1">
                    ...
                    <div id="accordion" class="accordion">
                        <div class="card mb-0">
                            ...
                            <div id="collapse1" class="card-body collapse" data-parent="#accordion" style="">
                                <p>De Taxichauffeurs op de luchthaven zijn goed uiteraard vertrouwd met  de verschillende hallen en weten welke maatschappijen zich wanneer in welke terminal ophouden. Dit komt natuurlijk omdat zij een groot deel van hun tijd op het vliegveld aanwezig zijn.</p>

                                 <p>Dat soort ervaring met de  luchthavendiensten voor het ophalen en wegbrengen van mensen zal uw reis minder stressvol maken en het vervoer van uw bagage vergemakkelijken.</p>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse5" aria-expanded="false">
                                <a class="card-title">
                                    Online uw Schiphol Luchthaven taxichauffeur bestellen
                                </a>
                            </div>
                            <div id="collapse5" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                <p>U kunt op onze website een taxi van Haarlem naar Schiphol reserveren. Een aanrader, Dit is zeker aan te raden als u niet in de rij wilt staan. Onze luchthaven taxidienst heeft een gebruiksvriendelijke boeking optie.</p>

                                <p>Ga daarvoor naar de online boekingsoptie op onze website,  reserveer via Whatsapp, of bel ons. Reserveer een pick-up, en het voertuig van uw keuze wacht op u wanneer u op het vliegveld aankomt.</p>
                                </div>
                            </div>
                            ...
                            <div id="collapse6" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Met geld kan je geen tijd kopen. Daarom wilt u het niet onnodig verspillen.</p>

                                    <p>Het voordeel van luchthaven taxidienst is dat  ze u rechtstreeks naar uw bestemming brengen zonder omwegen. De chauffeurs zijn ook goed vertrouwd met sluiproutes in het verkeer. In tegenstelling tot een luchthaven-shuttle, die andere passagiers moet oppikken en afzetten, kan een luchthaven taxi u rechtstreeks naar uw bestemming brengen zonder tussenstops.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false">
                                <a class="card-title">
                                    Wat zijn de taxidiensten van SPL.taxi naar de luchthaven vanuit Haarlem
                                </a>
                            </div>
                            <div id="collapse7" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Luchthaven transfer diensten zijn eigenlijk  precies zoals ze klinken; het zijn taxi diensten vanaf uw woonplaats Haarlem naar de luchthaven.</p><p>Of uiteraard , van de luchthaven naar uw eindbestemming.</p><p>U hoeft zich ook niet druk te maken over het tillen van uw koffers omdat de taxi} u van dienst is.</p><p>Bovendien kunnen deze taxi diensten worden gevraagd om naar andere locaties, zoals hotels, stations, en allerlei andere bezienswaardigheden in Haarlem vervoerd te worden,in aanvulling op taxi vervoer van het vliegveld naar uw huis.</p><p>Hoewel sommige mensen denken dat een een taxi chauffeur veel geld kost, blijkt dat in de realiteit eigenlijk  helemaal niet waar. Zeker niet indien u kiest voor SPL.taxi voor uw luchthaven transfer!</p><p>Hierstaan een aantal oorzaken waarom het nemen van een luchthaven<br>taxi wenselijk is.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false">
                                <a class="card-title">
                                    Transfer vanaf een aangeduide locatie in Haarlem naar Schiphol
                                </a>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-expanded="false">
                                <a class="card-title">
                                    Luchthaven Schiphol Taxi Haarlem: Reizen met comfort
                                </a>
                            </div>
            ...
            <div class="col-lg-12 mt-5 mb-3">
                <div class="fot-text fot-text2">
                    <h4>  € 40,00 Vaste Prijs met de Taxi van Haarlem naar Luchthaven!</h4>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div style="width: 100%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Haarlem+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/population/">Population Estimator map</a></iframe></div>
            </div>
        </div>
    </div>
</footer>
