...
<footer class="clr2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text">
                    <h4>Een Schiphol Taxi boekenvan/naar Duivendrecht provincie Noord-Holland</h4>
                    <h3>Tarief Van Duivendrecht naar Vliegveld Schiphol =
                        € 40,00</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="headingfot">
                    <h3>Boek uw Vliegveld Schiphol Taxi Online</h3>
                </div>
            </div>
            <div class="col-lg-8 mx-auto text-center">
                <form action="{{ route('reserve') }}" method="post">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text fot-text2">
                    <h4>Een Schiphol Taxi boekenvan/naar Duivendrecht provincie Noord-Holland</h4>
                    <h4>Vanaf  € 40,00 Flat-rate-Fee met de Taxi van Duivendrecht tot Schiphol!</h4>
                    <h4>Wij bieden u een luxe taxi naar Schiphol vanuit Duivendrecht, maar ook vanuit <a href="#">Ouderkerk aan de Amstel</a>, <a href="#">Amsterdam Oost</a>, <a href="#">Amsterdam</a>, <a href="#">Diemen</a>, <a href="#">Oud-Diemen</a>, <a href="#">Amstelveen</a>, <a href="#">De Pijp</a>, <a href="#">Amsterdam IJburg</a>, <a href="#">Amsterdam Zuid</a>, <a href="#">Amsterdam Centrum</a> en meer locaties rond <a href="#">Amstelveen</a></h4>
                </div>
            </div>
        </div>
    </div>
...
<section class="textionline">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="headingfot">
                    <h3>Of Boek uw Vliegveld Schiphol Taxi Per Telefoon</h3>
                </div>
            </div>
            <div class="col-lg-8 mx-auto text-center">
...
<footer class="clr2 footer2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="fot-text fot-text2">
                    <h4>Flat-rate-Fee met de Taxi van Duivendrecht naar Schiphol!</h4>
                    <h4>Auto € 40,00</h4>
                    <h4><i>(3 Personen 3 koffers / 4 Personen 4 trolleys)</i></h4>
                    <h4>Stationwagen € 42,50</h4>
                    <h4>Bus tot 6 Pax € 45,00</h4>
                    <h4>Bus tot 8 Pax € 50,00</h4>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="fot-text fot-text2">
                    <h4>Waarom Taxi Chauffeur van Duivendrecht naar Vliegveld Schiphol?</h4>
                    <h3>Wij bieden Taxi vervoer van Duivendrecht Noord-Holland naar luchthaven</h3>
                    <p>Reizen moet fijn zijn. Je leert bijvoorbeeld een nieuwe stad kennen, probeert ander eten en ontmoet nieuwe mensen. Internationaal reizen is dus altijd een opwindende ervaring, dus zorg ervoor dat alles soepel verloopt vanaf het moment dat u naar het vliegveld gaat, op luchthaven Schiphol landt tot u weer op weg naar huis bent. Dus, hoe wil u uw vakantie of zakelijke reis stressvrij beginnen? Uiteraard, neem een luchthaven taxi! </p>
                    <ul class="foot-list1">
                        ...
                        <li><i class="fa fa-check"></i>Uitgerust Aankomen</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-12">
                    ...
                    <div id="accordion" class="accordion">
                        <div class="card mb-0">
                            <div class="card-header collapsed" data-toggle="collapse" href="#collapse1" aria-expanded="false">
                                <a class="card-title">
                                    Vliegveld Schiphol taxi chauffeur zonder gedoe
                                </a>
                            </div>
                            <div id="collapse1" class="card-body collapse" data-parent="#accordion" style="">
                                <p>De Taxichauffeurs op de luchthaven zijn goed vertrouwd met  de verschillende (aankomst en vertrek) terminals van Schiphol en weten welke luchtvaartmaatschappijen zich wanneer waar bevinden. Dit komt voort uit het feit dat zij een aanzienlijk deel van hun tijd op luchthaven Schiphol aanwezig zijn.
                                </p>
                                    <p>Dat soort kennis van de  verschillende luchthavendiensten voor het ophalen en wegbrengen van mensen zal uw reis veel eenvoudiger maken en het vervoer van koffers vergemakkelijken.</p>
                            </div>
                            ...
                            <div id="collapse3" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Heeft u een limo nodig voor uw groep? Wat dacht u van een eenvoudige maar moderne taxi met eersteklas voorzieningen? Luchthaven taxi’s hebben alles! Wie zegt dat limousines alleen voor beroemdheden zijn als er zoveel moderne voertuigen zijn om uit te kiezen die ruim en goed onderhouden zijn?</p>
                                </div>
                            </div>
                            ...
                            <div id="collapse4" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>
                                        Vliegen kan vervelend zijn als het aankomt op geannuleerde en vertraagde vluchten. Het goede nieuws is dat luchthaven vervoersdiensten vlucht controlediensten aanbieden om ervoor te zorgen dat uw vlucht op tijd aankomt.
                                    </p>
                            ...
                            <div id="collapse5" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>U kunt <span style="text-decoration: underline;">online een taxi van Duivendrecht naar Schiphol reserveren</span>. Dat is ons advies als u niet er zeker van wilt zijn dat u op tijd een. taxi heeft. Onze luchthaven taxidienst heeft een gebruiksvriendelijke boeking optie.</p><p>Ga gewoon naar de online boekingsoptie op onze website,&nbsp; reserveer via Whatsapp, of bel ons. Reserveer een pick-up, en het voertuig van uw voorkeur zal op u wachten wanneer u op luchthaven Schiphol aankomt.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse6" aria-expanded="false">
                                <a class="card-title">
                                    Vliegveld Schiphol Taxi Bespaart uw tijd
                                </a>
                            </div>
                            <div id="collapse6" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>
                                        Tijd is niet te koop. Om die reden wilt u uw tijd niet verspillen.
                                    </p>
                                    <p>
                                     Het voordeel van luchthaven taxidienst is dat  ze u rechtstreeks naar uw bestemming brengen zonder omwegen. De chauffeurs zijn ook goed vertrouwd met sluiproutes in het verkeer. In tegenstelling tot een luchthaven-shuttle, die andere passagiers moet oppikken en afzetten, kan een luchthaven taxi u rechtstreeks naar uw bestemming brengen zonder tussenstops
                                     </p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false">
                                <a class="card-title">
                                    Wat zijn onze taxidiensten naar de luchthaven vanuit Duivendrecht
                                </a>
                            </div>
                            <div id="collapse7" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Vliegveld Schiphol transfer diensten zijn eigenlijk  precies zoals ze klinken; het zijn taxi diensten vanuit uw woonplaats Duivendrecht naar het vliegveld.</p><p>Of uiteraard omgekeerd , van de luchthaven naar uw eindbestemming.</p><p>U hoeft zich uiteraard niet druk te maken over het tillen van uw koffers omdat de taxi chauffeur} u van dienst is.</p><p>Uiteraard kunnen deze taxibedrijven worden gebruikt om naar andere locaties, zoals hotels, stations, of eigenlijk alle andere bezienswaardigheden in de buurt van Duivendrecht te reizen,in aanvulling op taxi vervoer van luchthaven Schiphol naar uw huis.</p><p>Hoewel sommige mensen beweren dat een een taxi chauffeur niet goedkoop is, is dat in de praktijk eigenlijk  helemaal niet waar. Zeker niet indien u kiest voor SPL.taxi voor uw luchthaven transfer!</p><p>Hieronder staan meerdere oorzaken waarom het nemen van een luchthaven<br>taxi voordelig is.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false">
                                <a class="card-title">
                                    Taxi vanuit een aangeven locatie in de regio Duivendrecht naar Schiphol
                                </a>
                            </div>
                            <div id="collapse8" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Gewoonlijk parkeert de chauffeur op de door de gebruiker aangegeven plaats en wacht hij naast het voertuig, net zoals een taxi.<br>Een dag voor de boekingsdatum zal het verkoopkantoor de taxidetails (naam van de chauffeur, contactpersoon en nummerplaat) naar de klant sturen, zodat u de chauffeur kunt contacteren als u de auto niet kunt vinden.</p><p>Wanneer u in de taxi stapt, brengt de chauffeur u rechtstreeks naar de luchthaven, zodat u ruim de tijd heeft om uw paspoort en vertrekterminalgegevens te controleren.<br>Als u de chauffeur uw vluchtnummer doorgeeft, zet hij u af bij de juiste vertrekhal. Deze diensten zijn uitstekend voor het verminderen van stress.</p>
                                </div>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-expanded="false">
                                <a class="card-title">
                                    Luchthaven Schiphol Taxi Duivendrecht: Reizen met comfort
                                </a>
                            </div>
                            <div id="collapse10" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Navigeren door onbekende straten kan een uitdaging zijn, en veel mensen zijn bezorgd over het vinden van een taxi wanneer ze aankomen.<br>Als u van tevoren een taxiservice boekt, zult u ongetwijfeld een professionele en plezierige reiservaring hebben.</p><p>Deze diensten hebben professionele en ervaren chauffeurs in dienst die een positieve relatie met hun passagiers kunnen ontwikkelen en ervoor kunnen zorgen dat ze zich tijdens hun reis op hun gemak voelen.</p><p>Een ander voordeel van het gebruik van een taxidienst is dat ze bekend zijn met lokale toeristische attracties die u kunt bezoeken op weg naar uw bestemming.</p>
                                </div>
                            </div>
            ...
            <div class="col-lg-12 mt-5 mb-3">
                <div class="fot-text fot-text2">
                    <h4>  € 40,00 Flat-rate-Fee met de Taxi van Duivendrecht naar Schiphol!</h4>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div style="width: 100%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Duivendrecht+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/population/">Population Estimator map</a></iframe></div>            </div>
        </div>
    </div>
</footer>
