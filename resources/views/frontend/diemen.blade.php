...
<footer class="clr2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text">
                    <h4>Een Luchthaven Taxi reserveren van/naar Diemen provincie Noord-Holland</h4>
                    <h3>Tarief Van Diemen Noord-Holland naar Luchthaven Schiphol =
                        € 40,00</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="headingfot">
                    <h3>Reserveer de Vliegveld Taxi Direct</h3>
                </div>
            </div>
            <div class="col-lg-8 mx-auto text-center">
                <form action="{{ route('reserve') }}" method="post">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="fot-text fot-text2">
                    <h4>Een Luchthaven Taxi reserveren van/naar Diemen provincie Noord-Holland</h4>
                    <h4>Al Vanaf Slechts € 40,00 Flat-rate-Fee met de Taxi van Diemen tot Luchthaven!</h4>

                    <h4>Wij leveren professionele taxi’s naar Schiphol vanuit o.a. Diemen, maar ook vanuit <a href="#">Ouderkerk aan de Amstel</a>, <a href="#">Oud-Diemen</a>, <a href="#">Amsterdam IJburg</a>, <a href="#">Over-Diemen</a>, <a href="#">Duivendrecht</a>, <a href="#">Amsterdam Oost</a>, <a href="#">Driemond</a>, <a href="#">Amsterdam</a>, <a href="#">Durgerdam</a>, Weesp en meer locaties in de regio <a href="#">Amstelveen</a></h4>
                </div>
            </div>
        </div>
    </div>
...
<section class="textionline">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="headingfot">
                    <h3>Of Reserveer de Vliegveld Taxi Per Telefoon</h3>
                </div>
            </div>
            <div class="col-lg-8 mx-auto text-center">
...
<footer class="clr2 footer2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="fot-text fot-text2">
                    <h4>Flat-rate-Fee met de Taxi van Diemen naar Luchthaven!</h4>
                    <h4>Auto € 40,00</h4>
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="fot-text fot-text2">
                    <h4>Waarom kiezen voor Taxi vervoer van Diemen naar Vliegveld Schiphol?</h4>
                    <h3>Wij bieden Taxi vervoer van Diemen Noord-Holland, naar vliegveld</h3>
                    <p>
                        Reizen met het vliegtuig kan fijn zijn. Je ervaart bijvoorbeeld een andere stad, probeert onbekend eten en leert nieuwe mensen kennen. Internationaal reizen is altijd een opwindende ervaring, dus zorg ervoor dat alles soepel verloopt vanaf het moment dat u naar het vliegveld gaat, of op het vliegveld landt tot u weer op weg naar huis bent. Dus, hoe kan u uw vakantie of zakelijke reis met zo min mogelijk stress beginnen? Natuurlijk, reserveer een vliegveld taxi! </p>
                    <ul class="foot-list1">
                        <li><i class="fa fa-check"></i>Vliegveld zonder gedoe</li>
                    ...
                    <div id="accordion" class="accordion">
                        <div class="card mb-0">
                            <div class="card-header collapsed" data-toggle="collapse" href="#collapse1" aria-expanded="false">
                                <a class="card-title">
                                    Vliegveld taxi chauffeur zonder gedoe
                                </a>
                            </div>
                            <div id="collapse1" class="card-body collapse" data-parent="#accordion" style="">
                                <p>Taxichauffeurs op de luchthaven zijn goed natuurlijk ervaren met  de verschillende hallen en kunnen nagaan welke luchtvaartmaatschappijen zich wanneer waar ophouden. Dit komt natuurlijk omdat ze een groot deel van hun tijd op het vliegveld doorbrengen.
<br>
                                    Hun ervaring met de  luchthavendiensten voor het ophalen en wegbrengen van passagiers zal uw reis veel comfortabeler maken en het vervoer van uw bagage vereenvoudigen.</p>
                            ...
                            <div id="collapse4" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <p>
                                     U zal tijd winnen door niet te moeten wachten op de luchthaven.</p>
                            ...
                            <div id="collapse5" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                   <p> U kunt online een taxi van Diemen naar Schiphol reserveren. Aan te raden als u niet in de rij wilt staan. Onze luchthaven taxidienst heeft een zeer effectieve boeking moeglijkheid.</p>

                                    <p>Klik gewoon op de online boekingsoptie op onze website,  reserveer via Whatsapp, of bel ons. Plan een taxi , en het voertuig dat u gekozen heeft wacht op u wanneer u op het vliegveld aankomt.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse6" aria-expanded="false">
                                <a class="card-title">
                                    Vliegveld Taxi Bespaart uw tijd
                                </a>
                            </div>
                            <div id="collapse6" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>
                                        Tijd is niet te koop. Daarom wilt u het niet kwijtraken.
                                    </p>
                                    <p>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false">
                                <a class="card-title">
                                    Wat zijn de taxidiensten van SPL.taxi naar de luchthaven vanuit Diemen
                                </a>
                            </div>
                            <div id="collapse7" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Vliegveld transfer diensten zijn eigenlijk  precies zoals ze klinken; het zijn taxi diensten vanuw locatie Diemen naar het vliegveld.</p><p>En uiteraard , van Schiphol naar uw woonplaats.</p><p>U hoeft niet na te denken over het tillen van uw koffers omdat de taxi} u van dienst is.</p><p>Bovendien kunnen deze taxi’s worden gebruikt om naar andere locaties, zoals hotels, stations, of allerlei andere bezienswaardigheden in de buurt van Diemen te reizen,als alternatief op taxi vervoer van het vliegveld naar uw huis.</p><p>Hoewel sommigen beweren dat een het niet voordelig is, blijkt dat in de realiteit eigenlijk  niet zo te zijn. Zeker niet wanneer u kiest voor SPL.taxi voor uw vliegveld transfer!</p><p>Hieronder vindt u meerdere oorzaken waarom het nemen van een vliegveld<br>taxi niet kostbaar is.</p>
                                </div>
                            </div>
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false">
                                <a class="card-title">
                                    Taxi vanaf iedere plaats in Diemen naar Schiphol
                                </a>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-expanded="false">
                                <a class="card-title">
                                    Vliegveld Schiphol Taxi Diemen: Reizen met comfort
                                </a>
                            </div>
            ...
            <div class="col-lg-6">
                <div style="width: 100%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Diemen+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/population/">Find Population on Map</a></iframe></div>
            </div>
        </div>
    </div>
</footer>
